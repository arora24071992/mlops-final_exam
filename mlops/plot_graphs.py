...
for n in range(n_cv):
    ...
    models_of_choice = {
        "svm": svm.SVC(),
        "decision_tree": tree.DecisionTreeClassifier(random_state=args.random_state),
    }
    ...
    results_name = args.clf_name + "_" + str(args.random_state) + ".txt"
...
print(results)
save_model_result(actual_model_path,x_test,y_test,args.clf_name,args.random_state)